...
export default function UpdateListing() {
    ...
    const handleImageSubmit = (e) => {
        ...
        if(files.length > 0 && files.length + formData.imageUrls.length < 7) {
            ...
            setImageUploadError('Yu can upload 6 images per listing')
            setUploading(false)
        }
    }
    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4 '>
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <input type='text'  placeholder='Address' className='border p-3 rounded-lg' onChange={handleChange} value={formData.address}
                id='address' required />
            ...
            <div className="flex flex-col flex-1 gap-4">
                ...
                <button disabled={loading || uploading} className='bg-slate-700 text-white rounded-lg p-3 uppercase hover:opacity-95
                        disabled:opacity-80'>
